...
//main 
  $site = $_REQUEST["site"]; 
  $rawdatafile = $site . "http://www.meteomaspalomas.com/clientraw.txt"; 
...
<rss version="2.0"> 
  <channel> 
      ...
      <item> 
         ...
         <description> {$data[SUMMARY]} . Wind {$data[WINDSPEED]} knots from {$data[WINDDIRECTION]} . Temperature {$data[TEMPERATURE]} &#0176;C. </description> 
      </item> 
  </channel> 
 </rss> 
EOT;
